                ...
                <tr>
                  ...
                  <td class="radio">
                    <v-radio-group v-model="homepageUserConfigSmsName" :mandatory="false">
                      <v-radio label="사용" value="SYS22A12B019"></v-radio>
                      <v-radio label="미사용" value="SYS22A12B020"></v-radio>
                    </v-radio-group>
                  </td>
                  <td>Email 수신여부</td>
                  <td class="radio">
                    <v-radio-group v-model="homepageUserConfigEmailName" :mandatory="false">
                      <v-radio label="사용" value="SYS22A12B021"></v-radio>
                      <v-radio label="미사용" value="SYS22A12B022"></v-radio>
                    </v-radio-group>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="radio">
                    <v-radio-group v-model="homepageUserConfigPushName" :mandatory="false">
                      <v-radio label="사용" value="SYS22A12B023"></v-radio>
                      <v-radio label="미사용" value="SYS22A12B024"></v-radio>
                    </v-radio-group>
                  </td>
                  <td>프로모션 수신여부</td>
                  <td class="radio">
                    <v-radio-group v-model="homepageUserConfigPromotionName" :mandatory="false">
                      <v-radio label="사용" value="SYS22A12B025"></v-radio>
                      <v-radio label="미사용" value="SYS22A12B026"></v-radio>
                    </v-radio-group>
                  </td>
                </tr>
              </table>
